...
import { ProvideParentAndViewportSize, ConstraintsContext, ParentSizeState } from "../../types/NewConstraints.js";
...
export class DeprecatedFrame extends Layer {
    ...
    render() {
        ...
        return (React.createElement("div", { id: id, style: style, ref: this.setElement, className: className },
            React.createElement(ProvideParentAndViewportSize, { parentSize: parentSize, viewportSize: null }, this.layoutChildren()),
